...
impl Pkcs12Builder {
    ...
    pub fn cert(&mut self, cert: X509) -> &mut Self {
        self.cert = Some(cert);
        self
    }

    pub fn friendly_name(&mut self, friendly_name: String) -> &mut Self {
        self.friendly_name = Some(CString::new(friendly_name).unwrap());
        self
    }
